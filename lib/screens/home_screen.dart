          ...
          children: [
            ...
            Expanded(
              child: GridView.count(
                ...
                crossAxisSpacing: 20,
                children: [
                  _buildMenuItem('', 'assets/icons/Dashboard.png', Colors.blue.shade900, '/dashboard'),
                  _buildMenuItem('', 'assets/icons/Wallet.png', Colors.purple.shade900, '/wallet'),
                  _buildMenuItem('', 'assets/icons/Videos.png', Colors.red.shade900, '/videos'),
                  _buildMenuItem('', 'assets/icons/Challenges.png', Colors.orange.shade900, '/challenges'),
                  _buildMenuItem('', 'assets/icons/Profile.png', Colors.green.shade900, '/profile'),
                ],
              ),
            ),
          ],
